...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/click-repl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6648&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/click-repl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `click-repl` can be installed with:

```
conda install click-repl
```

It is possible to list all of the versions of `click-repl` available on your platform with:
